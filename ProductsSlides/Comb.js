    ...
    return (
        <View style={styles.container}>
         <Swiper style={styles.wrapper}>
            ...
            <Image source={{uri: 'https://clhgroup.co.uk/images/product/l/504520-1.jpg?t=1674750979'}} style={styles.image} />
            </View>
            <View style={styles.slide}>
            ...
            <View style={styles.slide}>
            <Image source={{uri: 'https://pngimg.com/uploads/comb/comb_PNG104.png'}} style={styles.image} />
            </View>
         </Swiper>
         
         <Text style={styles.fontColor}>Comb</Text> 
